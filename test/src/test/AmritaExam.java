...
{ 
    ...
    { 
        ...
        txtName.setBounds(400, 20, 100, 20);
        lblName.setBounds(350,20,100,20);
    ...
    { 
        ...
        { 
            ...
            JOptionPane.showMessageDialog(this,"All the Very Best *" + txtName.getText() + "* Lets See Your Mark Card ");
            JOptionPane.showMessageDialog(this,"Total Marks Secured = " + total); 
            JOptionPane.showMessageDialog(this,"Perceddntage Marks =" + percentage); 
            System.exit(0);
        } 
